package com.nepplus.pizzaorderapplication_20210407.fragments
...
import com.nepplus.pizzaorderapplication_20210407.ViewStoreDetailActivity
import com.nepplus.pizzaorderapplication_20210407.adapters.PizzaStoreAdapter
...
class PizzaStoreFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
       ...
       mPizzaAdapter = PizzaStoreAdapter(activity!!, R.layout.store_list_item, mPizzaStoreList)
       ...
       pizzaListView.setOnItemClickListener { parent, view, position, id ->
          ...
          myIntent.putExtra("pizza", clickedStore)
